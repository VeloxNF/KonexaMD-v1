...
app.listen(port, () => {
  console.log(chalk.green(`⚡ Port ${port} telah dibuka`));
});
...
"Versi": packageJsonObj.version,
"Deskripsi": packageJsonObj.description,
"Os": os.type(),
"Memori": freeRamInGB.toFixed(2) + ' / ' + ramInGB.toFixed(2),
"IP": data,
"Owner": global.info.nomerown,
"Fitur": `${totalFoldersAndFiles.files} Fitur`,
"Creator": `Tio`
})
